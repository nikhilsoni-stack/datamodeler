...
<script src="webservice/js/TMService.js">
</script>

<script src="/toddatamodel/js/login.js"></script>
...
<body class="bg-dark">
    ...
    <div class="container">
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          <form id="loginForm" action="/toddatamodel/webservice/memberService/login" method="POST">
...
<span id="errorMessage" class="help-block label-danger">${errorBean.errorMessage}</span>
            ...
            <a class="btn btn-primary btn-block" onclick="submitForm()">Login</a>
          </form>
          <div class="text-center">
            <a class="d-block small mt-3" href="/toddatamodel/register1.html">Register an Account</a>
          </div>
        </div>
      </div>
    </div>
